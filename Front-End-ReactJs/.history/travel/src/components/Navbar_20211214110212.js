        ...
        <nav className="header-navigation stricky original">
          <div className="container">
            <div className="main-nav__logo-box">
              <a href="/vi" className="main-nav__logo">
                <img src="/image/logo.png" className="main-logo" width="123px" alt="Cổng thông tin du lịch Phú Thọ" /></a>
              <a href="#" className="side-menu__toggler"><i className="fa fa-bars" /></a>
            </div>
            <div className="main-nav__main-navigation">
              <ul className="main-nav__navigation-box">
                <li><a href="/vi" target>TRANG CHỦ</a></li>
                <li><a href="http://phutho.vietnaminfo.net/vi/blog/details/gioi-thieu-chung-ve-tinh-phu-tho-1" target>GIỚI THIỆU</a></li>
                <li><a href="/vi/places"  >ĐIỂM DU LỊCH</a></li>
                <li><a href="/vi/vtours"  >KHÁM PHÁ 3D</a></li>
                <li><a href="/vi/tours"  >TOUR DU LỊCH</a></li>
                <li><a href="/vi/blogs/tin-tuc-24" >TIN TỨC</a></li>
                <li><a href="/vi/hotels"  >LƯU TRÚ</a></li>
                <li><a href="/vi/agencies"  >LỮ HÀNH</a></li>
                <li><a href="/vi/restaurants"  >ẨM THỰC</a></li>
              </ul>
            </div>
          </div>
        </nav>
