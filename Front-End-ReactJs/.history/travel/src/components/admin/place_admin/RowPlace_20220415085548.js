            ...
            <td>
              <div className="list-image">
                { 
                  ...
                  return (                               
                          <a key={index} href={constant.IMAGE_PLACE+img.url}><span ><img className="image-columm" src= {constant.IMAGE_PLACE+img.url} alt={constant.IMAGE_PLACE+img.url} title={constant.IMAGE_PLACE+img.url}/>      </span></a>                                
                      )
                  })
                }      
              </div>
